            ...
            <div className="pt-32 pb-16">
                <Container>
                    ...
                    <div className="prose prose-invert max-w-none text-gray-300">
                        ...
                        <h2 className="text-xl font-bold text-white mt-8 mb-4">Garantía de 48 horas</h2>
                        <p>Tiene derecho a solicitar un reembolso completo dentro de las 48 horas posteriores a su compra, siempre y cuando no haya completado más del 30% del contenido del curso.</p>
