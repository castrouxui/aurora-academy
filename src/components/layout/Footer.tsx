...
export function Footer() {
    return (
        <footer className="w-full">
            {/* Top Banner */}
            <div className="bg-[#4F46E5] text-white py-16 px-4 md:px-8">
            ...
            {/* Bottom Footer */}
            <div className="bg-[#121620] text-gray-400 py-16 px-4 md:px-8 border-t border-gray-800">
                ...
                <div className="container mx-auto mt-16 pt-8 border-t border-gray-800 text-center text-sm text-gray-500">
