                ...
                <div className="flex flex-col items-center space-y-6 md:space-y-8 text-center px-4 md:px-0">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center">
                        <Link href="/membresias" className="w-full sm:w-auto">
                            <Button
                                className="h-14 px-8 sm:px-10 text-sm font-bold w-full sm:w-auto bg-[#5D5CDE] hover:bg-[#4B4AC0] text-white rounded-xl shadow-lg shiny-hover transition-all active:scale-95"
                            >
                                Suscribirme
                            </Button>
                        </Link>
